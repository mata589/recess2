...
class ColorConstant {
  ...
  static Color gray105 = fromHex('#f4f6fa');

  static Color gray103 = fromHex('#f3f3f5');
  ...
  static Color gray102 = fromHex('#f4f5f7');
  ...
  static Color bluegray801 = fromHex('#343c6a');

  static Color indigo301 = fromHex('#718ebf');

  static Color bluegray800 = fromHex('#333b69');
